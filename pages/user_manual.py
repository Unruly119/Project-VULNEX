...
<div class="manual-step" style="--i:1">
  ...
  <div class="manual-step-body">
    ...
    <p class="manual-step-desc">
      กดปุ่มสีเข้มใต้ช่อง URL ระบบจะเริ่มสแกนความปลอดภัยหลายด้านพร้อมกัน
      (Headers, SSL, DNS, Cookies, JavaScript, Subdomains และอื่น ๆ) แล้วให้ AI วิเคราะห์ผล
...
_REFS = [
    ...
    (I_SEARCH, "ปุ่ม “เริ่มตรวจสอบ”",
     "เริ่มสแกนความปลอดภัยหลายด้านพร้อมกัน แล้วให้ AI วิเคราะห์ผล",
     "อยู่ใต้ช่อง URL"),
